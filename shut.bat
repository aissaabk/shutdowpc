...
echo %id%
if %id% EQU 1 (set /p time="Enter time in min : "&&set /a "timemin=time*60"&&echo Pc shutdown after %time% min &&timeout 10&& goto shutdown ) else ( set /p app="enter name application complete like Viber.exe : ")
echo %app%
:loop
